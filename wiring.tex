...
\begin{tikzpicture}[line width=1.1pt, font=\sffamily]
  ...
  \draw ({0.7*2},4.0) -- ({0.7*2},2.6);
  \draw ({0.7*2},2.6) to[R, l=\footnotesize $R_{inA}$] ({0.7*2},1.3)
        to[leD, l=\footnotesize LED$_A$] ({0.7*2},0.4);
  \draw[gnd] ({0.7*2},0.4) -- ({0.7*2},0.0);
  ...
  \draw ({0.7*31},9.0)--({0.7*31},7.2); \draw ({0.7*31},7.2) to[R, l_=\footnotesize $R_{B1}$] ({0.7*31},5.7) -- ({0.7*31},3.0);
